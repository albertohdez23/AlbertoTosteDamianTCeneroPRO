...
/**
 * La clase Interfaz es la encargada de mostrar todo en pantalla, desde el menu
 * inicial, el HUD de la partida, o la tabla de puntuaciones.
 *
...
public class Interfaz {
    ...
    /**
     * Se muestra una tala con las puntuaciones de un jugador ordenado de mejor
     * a peor, separado por dificultad.
     *
    ...
    /**
     * Mustra una tabla donde se ve el jugador elegido y su puntuacion de esa
     * partida
     *
     * @param p1 jugador
    ...
    /**
     * Mensaje para mostrar a que no hay jugadores registrados
     * @return
     */
    ...
    /**
     * Mensaje para mostrar a que no existe el jugador
     * @return
     */
...
/**
 * Ranking de la dificultad facil
 * @param ordenjugador TreeSet de los jugadores ordenados por su mejor puntuacion dentro de la dificultad
 * @return 
 */
    public String RankingFacil(TreeSet ordenjugador) {

        String res = "";
        String Personas = "";
        TreeSet<Jugador> Jugadores;
        Jugadores = ordenjugador;
        String espFallos = "";
        String espExtra = "";
        int i = 0;
        for (Jugador j : Jugadores) {
            if (i < 6) {
                if (j.getMejorIntentoF() < 10) {
                    espFallos = "  ";
                    i += 1;
                } else {
                    espFallos = " ";
                ...
                Personas += "|        " + ((Jugador) j).getNombre() + "   ------------------------   " + ((Jugador) j).mejorIntentoF + espFallos + "       |\n";
            }
    ...
    /**
     * Ranking de la dificultad moderada
     * @param ordenjugador TreeSet de los jugadores ordenados por su mejor puntuacion dentro de la dificultad
     * @return 
     */
        public String RankingMedia(TreeSet ordenjugador) {
        ...
        for (Jugador j : Jugadores) {
            if (i < 6) {
                ...
                Personas += "|        " + ((Jugador) j).getNombre() + "   ------------------------   " + ((Jugador) j).mejorIntentoM + espFallos + "       |\n";
            }
     ...
     /**
     * Ranking de la dificultad dificil
     * @param ordenjugador TreeSet de los jugadores ordenados por su mejor puntuacion dentro de la dificultad
     * @return 
     */
        public String RankingDificil(TreeSet ordenjugador) {
        ...
        for (Jugador j : Jugadores) {
            if (i < 6) {
                ...
                Personas += "|        " + ((Jugador) j).getNombre() + "   ------------------------   " + ((Jugador) j).mejorIntentoD + espFallos + "       |\n";
            }
